 ...
 * @param    {Function} callback
 */
Identity.setAfterMethod('ready', function connect(preferred_port, callback) {
...
Identity.setMethod(function signBuffer(buffer, private_key_hex) {
	return this.peerpin.blockchain.chainful.signBuffer(buffer, private_key_hex);
});
...
Identity.setMethod(function verifyBuffer(buffer, signature, public_key_hex) {
	return this.peerpin.blockchain.chainful.verifyBuffer(buffer, signature, public_key_hex);
});
