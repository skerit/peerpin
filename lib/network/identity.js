...
Identity.setMethod(function claimValue(force, db_name, value, data, callback) {
	...
	if (!this.peerpin.hasBeenSeen('blockchain_ready')) {
		return this.peerpin.afterOnce('blockchain_ready', function ready() {
			that.claimValue(force, db_name, value, data, callback);
		});
	}
	...
	Fn.series(function waitForVote(next) {
